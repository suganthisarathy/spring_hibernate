...
public class CustomerController {
	...
	@RequestMapping("/edit/{customerId}")
	   public String editCustomer(@PathVariable("customerId")Integer cid,
		Map<String,Object> map)
	   {
		
		
		map.put("customer", customerService.getCustomerById(cid));
		log.info("getting details for customer if"+cid);
		map.put("customerList", customerService.listCustomer());
	...
	public String deleteCustomer(@PathVariable("customerId")Integer customerId)
		{
			...
			log.info("Deleting cuatomer information"+customerId);
			return "redirect:/index";
		}
